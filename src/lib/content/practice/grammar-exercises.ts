...
grammarExercises.push(
  ...
  E("g-adv-4", "gram-adverbial-clauses", "Adverbial clauses", "gap_fill", 2,
    "___ it was raining heavily, the match went ahead.", ["Because", "Although", "Since"], 1,
    "'Although' expresses the contrast between rain and the match continuing.", "adverbial clauses"),
