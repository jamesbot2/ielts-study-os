...
export const grammarExercises: GrammarExercise[] = [
  ...
  },
  {
    id: "g-cohesion-2",
    topic: "Cohesion",
    sentence: "Choose the best link: 'Unemployment rose sharply. ___, consumer spending fell.'",
...
grammarExercises.push(
  ...
  E("g-clause-2", "gram-clauses", "Clauses and clause boundaries", "sentence_choice", 2,
    "Which is punctuated correctly?", ["When the course finished everyone celebrated.", "When the course finished, everyone celebrated.", "When the course finished; everyone celebrated."], 1,
    "A dependent clause at the start of a sentence is followed by a comma.", "punctuation"),
  ...
  E("g-rel-7", "gram-relative-clauses", "Relative clauses", "sentence_choice", 2,
    "Which is correct?", ["My sister, that lives abroad, is visiting.", "My sister, who lives abroad, is visiting.", "My sister who lives abroad, is visiting."], 1,
    "Non-defining relative clauses use 'who' (not 'that') and need two commas.", "relative clauses"),
  ...
  E("g-ger-5", "gram-gerunds-infinitives", "Gerunds / infinitives", "sentence_choice", 2,
    "Which is correct?", ["I remember to visit the museum as a child.", "I remember visiting the museum as a child.", "I remember visit the museum as a child."], 1,
  ...
  E("g-ger-8", "gram-gerunds-infinitives", "Gerunds / infinitives", "sentence_choice", 3,
    "Which is correct?", ["She stopped to answer the phone.", "She stopped answer the phone.", "She stopped to answering the phone."], 0,
  ...
  E("g-cx-5", "gram-complex-control", "Complex clauses", "sentence_choice", 2,
    "Which is the clearest?", ["Because of it rained, the event was cancelled.", "Because it rained, the event was cancelled.", "Because raining, the event was cancelled."], 1,
  ...
  E("g-cx-6", "gram-complex-control", "Complex clauses", "sentence_choice", 3,
    "Choose the controlled complex sentence.", ["The scheme, which the council launched, has reduced, according to the report, traffic.", "The scheme which the council launched has reduced traffic according to the report.", "The scheme, which the council launched, has reduced traffic, according to the report."], 2,
    "Commas correctly set off both the non-defining clause and the reporting phrase.", "complex sentences"),
  ...
  E("g-punct-5", "gram-punctuation", "Punctuation", "punctuation", 1,
    "Choose the correct version.", ["The results were clear, the method was flawed.", "The results were clear; the method was flawed.", "The results were clear the method was flawed."], 1,
    "A semicolon correctly joins two closely related independent clauses.", "punctuation"),
  E("g-punct-6", "gram-punctuation", "Punctuation", "punctuation", 2,
    "Choose the correct version.", ["In 2020, sales fell, however, profits rose.", "In 2020, sales fell; however, profits rose.", "In 2020, sales fell however profits rose."], 1,
    "A semicolon (or full stop) is required before 'however'.", "punctuation"),
  E("g-punct-7", "gram-punctuation", "Punctuation", "punctuation", 2,
    "Choose the correct version.", ["The course covers reading, writing and listening.", "The course covers reading writing and listening.", "The course covers, reading, writing, and listening."], 0,
    "Commas separate the items; the Oxford comma before 'and' is optional in IELTS but the list needs commas.", "punctuation"),
  E("g-punct-8", "gram-punctuation", "Punctuation", "punctuation", 2,
    "Choose the correct version.", ["The government's policy was criticised.", "The governments policy was criticised.", "The governments' policy were criticised."], 0,
    "Singular possessor 'government' takes an apostrophe before 's'.", "punctuation"),
  ...
  E("g-tense-7", "gram-tenses-conditionals", "Tense consistency", "gap_fill", 3,
    "By next summer, she ______ her thesis.", ["will complete", "will have completed", "completes"], 1,
    "Future perfect describes completion before a future point.", "tense"),
