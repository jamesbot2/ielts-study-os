...
const moreTopics: SpeakingTopic[] = [
  ...
  { id: "future", name: "The Future", tags: ["future", "society", "technology"], part1Questions: ["How do you imagine your life in ten years?", "Are you optimistic about the future?", "What changes would you like to see in the world?"], part2CueCards: [{ id: "future-change-1", topic: "A future change", prompt: "Describe a change you hope to see in the future.", bullets: ["what the change is", "why it is needed", "how it could happen"], followUp: "and explain how it would improve people's lives." }], part3Questions: ["What will cities look like in the future?", "How will technology change work?", "What global problems need to be solved?" ] },
  { id: "books", name: "Books & Reading", tags: ["books", "reading", "leisure"], part1Questions: ["Do you enjoy reading books?", "What kind of books do you like?", "Did you read much as a child?"], part2CueCards: [{ id: "books-1", topic: "A book you enjoyed", prompt: "Describe a book you enjoyed reading.", bullets: ["what the book was", "when you read it", "what it was about"], followUp: "and explain why you enjoyed it." }], part3Questions: ["Why do some people prefer e-books to printed books?", "Is reading still important in the digital age?" ] },
  { id: "food", name: "Food", tags: ["food", "diet", "culture"], part1Questions: ["What is your favourite food?", "Do you prefer home-cooked food or restaurant food?", "Has your diet changed over the years?"], part2CueCards: [{ id: "food-1", topic: "A meal you remember", prompt: "Describe a memorable meal you had.", bullets: ["where you had it", "who you were with", "what you ate"], followUp: "and explain why it was memorable." }], part3Questions: ["How has fast food changed people's eating habits?", "Is traditional food being lost in modern society?" ] },
  { id: "friends", name: "Friends", tags: ["friends", "relationships", "society"], part1Questions: ["How often do you meet your friends?", "What do you usually do with your friends?", "Are your friends mostly from school, work or elsewhere?"], part2CueCards: [{ id: "friends-1", topic: "A close friend", prompt: "Describe a close friend of yours.", bullets: ["how you met", "what you do together", "what they are like"], followUp: "and explain why this friendship is important to you." }], part3Questions: ["Why are friendships important?", "How has social media changed friendship?" ] },
  { id: "teachers", name: "Teachers & Mentors", tags: ["teachers", "education", "role models"], part1Questions: ["Who was your favourite teacher at school?", "What qualities make a good teacher?", "Has a teacher ever influenced your life?"], part2CueCards: [{ id: "teachers-1", topic: "A teacher you remember", prompt: "Describe a teacher who had an influence on you.", bullets: ["who they were", "what they taught", "how they influenced you"], followUp: "and explain why you remember them." }], part3Questions: ["What makes a good teacher?", "How is the role of teachers changing?" ] },
  { id: "environment", name: "Environment", tags: ["environment", "nature", "society"], part1Questions: ["How concerned are you about the environment?", "What do you do to help the environment?", "Are environmental issues discussed in your country?"], part2CueCards: [{ id: "environment-action-1", topic: "Something you do for the environment", prompt: "Describe something you do to help protect the environment.", bullets: ["what you do", "when you started doing it", "what difference it makes"], followUp: "and explain why it matters to you." }], part3Questions: ["Who should be responsible for protecting the environment?", "Will technology solve environmental problems?" ] },
  { id: "volunteering", name: "Volunteering & Charity", tags: ["volunteering", "charity", "society"], part1Questions: ["Have you ever done any volunteering?", "Why do people volunteer?", "Would you like to volunteer in the future?"], part2CueCards: [{ id: "volunteering-1", topic: "A volunteering experience", prompt: "Describe a time you helped someone or did volunteer work.", bullets: ["what you did", "who you helped", "why you did it"], followUp: "and explain how it made you feel." }], part3Questions: ["Why is volunteering important?", "Should volunteering be part of the school curriculum?" ] },
  { id: "success", name: "Success & Achievement", tags: ["success", "achievement", "goals"], part1Questions: ["What does success mean to you?", "Have you ever achieved a difficult goal?", "Do you think success comes from luck or hard work?"], part2CueCards: [{ id: "success-1", topic: "An achievement you are proud of", prompt: "Describe an achievement you are proud of.", bullets: ["what you achieved", "when it happened", "what you had to do"], followUp: "and explain why you are proud of it." }], part3Questions: ["How do people define success differently?", "Is ambition always a good thing?" ] },
  { id: "skills", name: "Skills & Hobbies", tags: ["skills", "hobbies", "learning"], part1Questions: ["What skills would you like to learn?", "How did you learn your most useful skill?", "Do you have any unusual hobbies?"], part2CueCards: [{ id: "skills-1", topic: "A skill you learned", prompt: "Describe a skill you learned that is useful to you.", bullets: ["what the skill is", "how you learned it", "how you use it"], followUp: "and explain why it is useful." }], part3Questions: ["Which skills are most valuable in today's job market?", "Should schools teach practical skills?" ] },
  { id: "home", name: "Home & Accommodation", tags: ["home", "accommodation", "living"], part1Questions: ["Do you live in a house or a flat?", "What is your favourite room?", "Would you like to move home in the future?"], part2CueCards: [{ id: "home-1", topic: "A place you lived", prompt: "Describe a home you have lived in.", bullets: ["where it was", "what it looked like", "who you lived with"], followUp: "and explain what you liked or disliked about it." }], part3Questions: ["Why is housing so expensive in many cities?", "Is it better to rent or buy a home?" ] },
  { id: "health", name: "Health & Wellbeing", tags: ["health", "wellbeing", "lifestyle"], part1Questions: ["What do you do to stay healthy?", "How important is sleep to you?", "Do you ever feel stressed?"], part2CueCards: [{ id: "health-energetic-1", topic: "A time you felt healthy", prompt: "Describe a time when you felt particularly healthy or energetic.", bullets: ["when it was", "what you had been doing", "how you felt"], followUp: "and explain why you remember it." }], part3Questions: ["Why do many people find it hard to live healthily?", "Should the government promote healthy lifestyles?" ] },
  { id: "city-life", name: "City Life", tags: ["cities", "urban", "lifestyle"], part1Questions: ["Do you enjoy living in a city?", "What are the advantages of city life?", "Would you prefer to live in a smaller town?"], part2CueCards: [{ id: "city-1", topic: "A city you know well", prompt: "Describe a city you know well.", bullets: ["where it is", "what it is known for", "what you like to do there"], followUp: "and explain what makes it special." }], part3Questions: ["How can cities become more liveable?", "Are cities becoming too crowded?" ] },
  { id: "time", name: "Time Management", tags: ["time", "organisation", "productivity"], part1Questions: ["Are you good at managing your time?", "How do you plan your day?", "Do you ever waste time?"], part2CueCards: [{ id: "time-1", topic: "A time you were well organised", prompt: "Describe a time when you managed your time very well.", bullets: ["what you had to do", "how you organised yourself", "what the result was"], followUp: "and explain why it worked well." }], part3Questions: ["Why do some people struggle with time management?", "How has technology changed the way people manage time?" ] },
  { id: "dreams", name: "Dreams & Goals", tags: ["dreams", "goals", "ambition"], part1Questions: ["What is a dream or goal you have?", "Did you have a different dream as a child?", "Do you think dreams are achievable?"], part2CueCards: [{ id: "dreams-1", topic: "A childhood ambition", prompt: "Describe an ambition you had when you were a child.", bullets: ["what the ambition was", "why you had it", "whether you still have it"], followUp: "and explain how it influenced you." }], part3Questions: ["Why is it important to have goals?", "Do people's goals change as they get older?" ] },
];
