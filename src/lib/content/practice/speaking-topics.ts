...
const moreTopics: SpeakingTopic[] = [
  ...
  { id: "environment", name: "Environment", tags: ["environment", "nature", "society"], part1Questions: ["How concerned are you about the environment?", "What do you do to help the environment?", "Are environmental issues discussed in your country?"], part2CueCards: [{ id: "environment-1", topic: "An environmental problem", prompt: "Describe an environmental problem in your country.", bullets: ["what the problem is", "what causes it", "how it affects people"], followUp: "and explain what could be done about it." }], part3Questions: ["Who should be responsible for protecting the environment?", "Will technology solve environmental problems?" ] },
  ...
  { id: "health", name: "Health & Wellbeing", tags: ["health", "wellbeing", "lifestyle"], part1Questions: ["What do you do to stay healthy?", "How important is sleep to you?", "Do you ever feel stressed?"], part2CueCards: [{ id: "health-1", topic: "A healthy habit", prompt: "Describe a healthy habit you have or would like to develop.", bullets: ["what the habit is", "how you started it", "how it affects your life"], followUp: "and explain why it is important." }], part3Questions: ["Why do many people find it hard to live healthily?", "Should the government promote healthy lifestyles?" ] },
  ...
  { id: "dreams", name: "Dreams & Goals", tags: ["dreams", "goals", "ambition"], part1Questions: ["What is a dream or goal you have?", "Did you have a different dream as a child?", "Do you think dreams are achievable?"], part2CueCards: [{ id: "dreams-1", topic: "A goal you want to achieve", prompt: "Describe a personal goal you hope to achieve.", bullets: ["what the goal is", "why you set it", "how you plan to achieve it"], followUp: "and explain how achieving it would change your life." }], part3Questions: ["Why is it important to have goals?", "Do people's goals change as they get older?" ] },
];
