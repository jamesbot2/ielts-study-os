...
const gtSection1Questions: Question[] = [
  ...
  choiceQ({
    ...
    passageId: "gt-s1a",
    prompt: "What must members show to use the Northgate pool for free?",
    explanation: "Membership card.",
    evidence: "Text 1: 'on presentation of their membership card'",
    skillTags: ["multiple choice", "detail"],
    difficulty: 1,
    options: [["A", "a receipt"], ["B", "their membership card"], ["C", "a booking form"]],
    correct: ["B"],
  }),
  textQ({
    id: "gt-q32",
    type: "true_false_not_given",
    passageId: "gt-s1b",
    prompt: "A sixteen-year-old may hire an electric bike.",
    explanation: "You must be 18 for an electric bike, so False.",
    evidence: "Text 2: '18 for an electric bike'",
    skillTags: ["true false not given", "detail"],
    difficulty: 2,
    correctAnswer: "false",
  }),
...
const gtSection2Questions: Question[] = [
  ...
  textQ({
    ...
    acceptableAnswers: ["the car park", "assembly point in the car park"],
  }),
  textQ({
    id: "gt-q15",
    type: "true_false_not_given",
  ...
  choiceQ({
    ...
    type: "multiple_choice",
    passageId: "gt-s2",
    prompt: "Where is the list of trained first aiders displayed?",
    explanation: "On each noticeboard.",
    evidence: "Text: 'displayed on each noticeboard'",
    skillTags: ["multiple choice", "detail"],
    difficulty: 1,
    options: [["A", "in the staff kitchen"], ["B", "on each noticeboard"], ["C", "at reception"]],
    correct: ["B"],
  }),
  textQ({
    id: "gt-q35",
    type: "true_false_not_given",
    passageId: "gt-s2",
    prompt: "Personal protective equipment must be worn where indicated.",
    explanation: "Stated directly, so True.",
    evidence: "Text: 'must be worn where indicated'",
    skillTags: ["true false not given", "detail"],
    difficulty: 1,
    correctAnswer: "true",
  }),
  textQ({
    ...
    type: "sentence_completion",
    passageId: "gt-s2",
    prompt: "Defective equipment must be taken out of service until it has been __________.",
    explanation: "inspected.",
    evidence: "Text: 'taken out of service until it has been inspected'",
    skillTags: ["sentence completion", "detail"],
    difficulty: 1,
    wordLimit: 1,
...
const gtSection3Questions: Question[] = [
  ...
  textQ({
    ...
    passageId: "gt-s3",
    prompt:
      "In several cities, former industrial districts have been converted into dedicated night-market __________.",
    explanation: "zones.",
    evidence: "Paragraph E: 'converted into dedicated night-market zones'",
    skillTags: ["sentence completion", "detail"],
    difficulty: 2,
    wordLimit: 1,
    correctAnswer: "zones",
  ...
  choiceQ({
    ...
    type: "multiple_choice",
    passageId: "gt-s3",
    prompt: "What is the writer's main point in the final paragraph?",
    explanation:
      "The night market satisfies a social need for shared public space that shopping centres and the internet cannot meet.",
    evidence: "Paragraph F",
    skillTags: ["multiple choice", "main idea"],
    difficulty: 3,
    options: [
      ["A", "night markets are better than the internet"],
      ["B", "people go to night markets mainly to buy things"],
      ["C", "night markets fulfil a social need for shared public space"],
      ["D", "shopping centres are becoming more popular"],
    ],
    correct: ["C"],
  }),
  textQ({
    ...
    passageId: "gt-s3",
    prompt:
      "City authorities typically address night-market problems through licensing and opening-hour limits.",
    explanation: "Stated directly in Paragraph D, so True.",
    evidence: "Paragraph D: 'typically through licensing, designated trading areas and limits on opening hours'",
    skillTags: ["true false not given", "detail"],
    difficulty: 2,
    correctAnswer: "true",
  }),
  ...
  textQ({
    ...
    type: "short_answer",
    passageId: "gt-s3",
    prompt: "Name ONE problem that residents living near night markets complain about.",
    explanation: "Residents complain about noise (also acceptable: litter or congestion).",
    evidence: "Paragraph D",
    skillTags: ["short answer", "detail"],
    difficulty: 2,
    wordLimit: 1,
    correctAnswer: "noise",
    acceptableAnswers: ["litter", "congestion", "traffic congestion"],
  }),
  choiceQ({
    id: "gt-q42",
    type: "multiple_choice",
    passageId: "gt-s3",
    prompt: "Why do some established retailers object to street vendors?",
    explanation: "They argue vendors compete unfairly because they pay lower rents and fewer taxes.",
    evidence: "Paragraph D",
    skillTags: ["multiple choice", "detail"],
    difficulty: 2,
    options: [["A", "vendors sell better goods"], ["B", "vendors pay lower rents and fewer taxes"], ["C", "vendors work longer hours"]],
    correct: ["B"],
  }),
  textQ({
    id: "gt-q43",
    type: "true_false_not_given",
    passageId: "gt-s3",
    prompt: "Starting a night-market stall requires less capital than opening a shop.",
    explanation: "Stated directly, so True.",
    evidence: "Paragraph C",
    skillTags: ["true false not given", "detail"],
    difficulty: 1,
  ...
  textQ({
    ...
    passageId: "gt-s3",
    prompt: "In several cities, former industrial districts have been converted into dedicated night-market __________.",
    explanation: "zones.",
  ...
  choiceQ({
    ...
    type: "multiple_choice",
    passageId: "gt-s3",
    prompt: "What need does the writer say the night market satisfies?",
    explanation: "The need for shared public space.",
    evidence: "Paragraph F",
    skillTags: ["multiple choice", "main idea"],
    difficulty: 2,
    options: [["A", "the need for cheap goods"], ["B", "the need for shared public space"], ["C", "the need for night-time entertainment"]],
    correct: ["B"],
  }),
];
