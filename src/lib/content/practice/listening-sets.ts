...
const part3Questions: Question[] = [
  ...
  choiceQ({ id: "list-p3-q39", type: "multiple_choice", prompt: "Who will the students present their findings to next month?", explanation: "The library committee.", evidence: "Part 3", skillTags: ["multiple choice", "detail"], difficulty: 1, options: [["A", "the university senate"], ["B", "the library committee"], ["C", "their classmates"]], correct: ["B"] }),
  textQ({ id: "list-p3-q40", type: "short_answer", prompt: "What will the report include alongside the survey results?", explanation: "Charts.", evidence: "Part 3", skillTags: ["short answer", "detail"], difficulty: 1, wordLimit: 1, allowNumber: false, correctAnswer: "charts" }),
];
