...
export const listeningShortAnswer02: PracticeSet = {
  ...
  questions: [
    ...
    textQ("short_answer", "listening-targeted-short-answer-02-q06", "Children under what age can enter the castle free?", "12", "Children under twelve go free, so twelve is the boundary age.", { wordLimit: 1, allowNumber: true, evidence: "under twelve", acceptableAnswers: ["twelve"], difficulty: 2 }),
