...
export const noteCompletionSet02: PracticeSet = {
  ...
  questions: [
    ...
    textQuestion("note_completion", "reading-targeted-note-completion-02-q04", "Replacement cost for a lost bike: __________ pounds.", "150", "Lost bikes are charged at the full replacement cost of one hundred and fifty pounds.", "reading-targeted-note-completion-02-p01", { wordLimit: 2, allowNumber: true, evidence: "one hundred and fifty pounds", acceptableAnswers: ["150"], difficulty: 2 }),
