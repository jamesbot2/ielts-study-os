...
export const shortAnswerSet01: PracticeSet = {
  ...
  questions: [
    ...
    textQuestion("short_answer", "reading-targeted-short-answer-01-q04", "In approximately which year did Eratosthenes make his calculation?", "240 BC", "Eratosthenes compared shadow angles in about 240 BC.", "reading-targeted-short-answer-01-p01", { wordLimit: 2, allowNumber: true, evidence: "240 BC", acceptableAnswers: ["240BC", "240"], difficulty: 2 }),
    ...
    textQuestion("short_answer", "reading-targeted-short-answer-01-q08", "When did captains have to hand in their charts?", "at the end of every voyage", "Captains handed charts in at the end of every voyage.", "reading-targeted-short-answer-01-p01", { wordLimit: 6, evidence: "at the end of every voyage", difficulty: 3 }),
  ],
};
...
const p2 = originalPassage(
  ...
  [
    ...
    "Households that produce large amounts of garden waste can subscribe to a separate brown-bin service, which costs thirty-five pounds per year and runs from March to November, then is suspended in December. Christmas trees are collected free of charge for two weeks in January if they are left beside the green bin.",
...
export const shortAnswerSet02: PracticeSet = {
  ...
  questions: [
    ...
    textQuestion("short_answer", "reading-targeted-short-answer-02-q02", "What can cause a whole load to be rejected at the sorting plant?", "items placed in the wrong bin", "Wrong items can cause the whole load to be rejected.", "reading-targeted-short-answer-02-p01", { wordLimit: 6, evidence: "items placed in the wrong bin", difficulty: 2 }),
    textQuestion("short_answer", "reading-targeted-short-answer-02-q03", "How much does the brown-bin garden waste service cost per year?", "35 pounds", "The brown-bin service costs thirty-five pounds per year.", "reading-targeted-short-answer-02-p01", { wordLimit: 3, allowNumber: true, evidence: "thirty-five pounds", acceptableAnswers: ["thirty-five pounds", "35"], difficulty: 1 }),
    textQuestion("short_answer", "reading-targeted-short-answer-02-q04", "In which month is the brown-bin service suspended for the winter?", "December", "The service runs from March to November, so it is suspended in December — November is the last month it runs, not the month it stops.", "reading-targeted-short-answer-02-p01", { wordLimit: 1, evidence: "March to November", difficulty: 3 }),
    ...
    textQuestion("short_answer", "reading-targeted-short-answer-02-q06", "Within how many hours should a missed collection be reported?", "48", "Missed collections should be reported within forty-eight hours.", "reading-targeted-short-answer-02-p01", { wordLimit: 2, allowNumber: true, evidence: "forty-eight hours", acceptableAnswers: ["forty-eight hours", "48 hours"], difficulty: 2 }),
    textQuestion("short_answer", "reading-targeted-short-answer-02-q07", "By what time must the bin be left out on collection day?", "seven in the morning", "The bin must be left out by seven in the morning.", "reading-targeted-short-answer-02-p01", { wordLimit: 4, allowNumber: true, evidence: "seven in the morning", acceptableAnswers: ["7 in the morning", "seven"], difficulty: 2 }),
    textQuestion("short_answer", "reading-targeted-short-answer-02-q08", "What other item does the green bin NOT accept, besides plastic bags and polystyrene?", "food waste", "The bin does not accept plastic bags, polystyrene, or food waste — food waste is the one other item named.", "reading-targeted-short-answer-02-p01", { wordLimit: 2, evidence: "food waste", difficulty: 2 }),
  ],
};
