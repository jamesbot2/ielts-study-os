...
export const tableCompletionSet01: PracticeSet = {
  ...
  questions: [
    ...
    textQuestion("table_completion", "reading-targeted-table-completion-01-q05", "Geothermal: runs turbines __________ hours a day.", "24", "Geothermal runs turbines twenty-four hours a day.", "reading-targeted-table-completion-01-p01", { wordLimit: 1, evidence: "twenty-four hours", acceptableAnswers: ["24", "twenty-four"], difficulty: 1 }),
