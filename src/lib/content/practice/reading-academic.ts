...
const passage2Questions: Question[] = [
  ...
  textQ({
    ...
    passageId: "ar-p2",
    prompt:
      "Complete the summary. Choose words from the passage.\nUrban beekeeping has grown because cities offer bees a __________ diet and fewer agricultural pesticides. However, too many hives can cause __________ with wild pollinators, and amateur beekeepers may not notice __________ spreading to wild bees.",
    explanation:
      "rich (Paragraph B), competition (Paragraph D), disease/pathogens (Paragraph E).",
    evidence: "Paragraphs B–D",
    skillTags: ["summary completion", "paraphrase"],
    difficulty: 4,
    wordLimit: 2,
    correctAnswer: "rich; competition; disease",
  }),
  textQ({
    id: "ar-p2-q22",
    type: "short_answer",
