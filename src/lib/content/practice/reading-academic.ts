...
const passage1Questions: Question[] = [
  ...
  textQ({
    ...
    passageId: "ar-p1",
    prompt:
      "Murano glassmakers were not allowed to leave the island.",
    explanation:
      "Paragraph E: 'they were forbidden, on pain of death, from leaving the island', so True.",
  ...
  textQ({
    ...
    passageId: "ar-p1",
    prompt:
      "The float-glass process, developed in Britain, floats molten glass on a bed of molten __________.",
    explanation:
      "Paragraph F states molten glass is floated on molten tin.",
    evidence: "Paragraph F: 'floated on a bed of molten tin'",
  ...
  textQ({
    ...
    passageId: "ar-p1",
    prompt:
      "In which century was the float-glass process developed?",
    explanation: "Paragraph F says it was developed in the 1950s, i.e. the twentieth century.",
    evidence: "Paragraph F: 'developed in Britain in the 1950s'",
    skillTags: ["short answer", "detail"],
    difficulty: 2,
    wordLimit: 3,
    allowNumber: false,
    correctAnswer: "twentieth century",
    acceptableAnswers: ["20th century", "1950s"],
  }),
  textQ({
    id: "ar-p1-q14",
    ...
    passageId: "ar-p1",
    prompt:
      "Complete the notes. Early glassmakers heated a mixture of sand, soda ash and __________.",
    explanation: "Paragraph A names the three ingredients: sand, soda ash and lime.",
    evidence: "Paragraph A: 'a mixture of sand, soda ash and lime'",
  ...
  choiceQ({
    ...
    passageId: "ar-p1",
    prompt: "What made glass cheap enough for everyday use?",
    explanation: "Paragraph B: glassblowing allowed vessels to be produced quickly and in many shapes.",
    evidence: "Paragraph B",
    skillTags: ["multiple choice", "detail"],
    difficulty: 2,
    options: [
      ["A", "the discovery of sand deposits"],
      ["B", "the development of glassblowing"],
      ["C", "the invention of the furnace"],
    ],
    correct: ["B"],
  }),
  textQ({
  ...
  textQ({
    ...
    type: "short_answer",
    passageId: "ar-p1",
    prompt: "Which civilisation spread glassmaking across Europe?",
    explanation: "Paragraph C: the Romans played a crucial role in spreading glassmaking across Europe.",
    ...
    acceptableAnswers: ["the romans", "roman empire"],
  }),
];
...
const passage2Questions: Question[] = [
  ...
  textQ({
    ...
    type: "short_answer",
    passageId: "ar-p2",
    prompt: "What may wild pollinators lack when there are too many hives?",
    explanation: "Too many hives can exhaust flowers, leaving wild pollinators with too little food.",
    evidence: "Paragraph D",
    skillTags: ["short answer", "detail"],
    difficulty: 2,
    wordLimit: 1,
    allowNumber: false,
    correctAnswer: "food",
    acceptableAnswers: ["enough food"],
  }),
  textQ({
    id: "ar-p2-q28",
    type: "true_false_not_given",
    passageId: "ar-p2",
    prompt: "Urban hives are always inspected less frequently than rural hives.",
    explanation: "The passage says urban hives are OFTEN kept by amateurs and MAY be inspected less frequently — not always. The statement overstates this, so it is False.",
    evidence: "Paragraph D",
  ...
  textQ({
    ...
    type: "sentence_completion",
    passageId: "ar-p2",
    prompt: "Urban parks, gardens and roadside plantings provide a wide variety of flowers across a long __________.",
    explanation: "Paragraph B says 'across a long season'.",
    evidence: "Paragraph B",
    skillTags: ["sentence completion", "detail"],
    difficulty: 1,
    wordLimit: 1,
  ...
  choiceQ({
    ...
    type: "multiple_choice",
    passageId: "ar-p2",
    prompt: "Why might disease spread unnoticed in urban hives?",
    explanation: "Because urban hives are often kept by amateurs and inspected less frequently.",
    evidence: "Paragraph D",
    skillTags: ["multiple choice", "detail"],
    difficulty: 2,
    options: [
      ["A", "urban bees are immune"],
      ["B", "amateur keepers may inspect less frequently"],
      ["C", "urban pathogens are invisible"],
    ],
    correct: ["B"],
  }),
];
...
const passage3Questions: Question[] = [
  ...
  textQ({
    ...
    type: "short_answer",
    passageId: "ar-p3",
    prompt: "According to the passage, consolidation appears to occur partly during what?",
    explanation: "Paragraph 3 says consolidation occurs partly during sleep.",
    evidence: "Paragraph 3",
    skillTags: ["short answer", "detail"],
    difficulty: 1,
    wordLimit: 1,
  ...
  textQ({
    ...
    type: "sentence_completion",
    passageId: "ar-p3",
    prompt: "Sensory memory lasts only a fraction of a __________.",
    explanation: "Paragraph 3 says sensory memory lasts only a fraction of a second.",
    evidence: "Paragraph 3",
    skillTags: ["sentence completion", "detail"],
    difficulty: 1,
    wordLimit: 1,
  ...
  textQ({
    ...
    type: "yes_no_not_given",
    passageId: "ar-p3",
    prompt: "The writer suggests forgetting can be useful.",
    explanation: "Paragraph 6 says forgetting is not necessarily a failure and may free capacity, so Yes.",
